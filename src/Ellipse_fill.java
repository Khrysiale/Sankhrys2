 ...
 * @version 1.0
 *
 * @author Trinôme[ FERHANE - BELHABRA - OUAGUID ] 
 * @copyright (C) LPSBDR
 * @notes  Mini-projet Paint en Java
 */
public class Ellipse_fill extends Ellipse2D.Double implements Dessinable{
/**
     ...
     */
        public Ellipse_fill(Point2D centre, Point2D point, Color _couleurRemplissage){
   ...
   /**
     ...
     */
     public String information() {
        String s="Ellipse plein(" + (int)getWidth()+" , "+ (int)getHeight()+")";
        return(s);
    }
    /**
